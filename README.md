...
1. [DualScale Diffusion: Adaptive Feature Balanc[README.md](README.md)ing for Low-Dimensional Generative Models](https://github.com/SakanaAI/AI-Scientist/blob/main/example_papers/adaptive_dual_scale_denoising.pdf)
